...
public class BlockedList extends AppCompatActivity {
    ...
    private void INIT() {
        ...
        block_list = (ListView) findViewById(R.id.blocklist);
        ...
        if (NetworkDetector.isNetworkStatusAvialable(BlockedList.this)) {

            getFrdList("","0");
            acProgressFlower = new ACProgressFlower.Builder(BlockedList.this)
    ...
    private void getFrdList(String s, String s1) {
        ...
        AndroidNetworking.post(Webservcie.block_list)
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (response.optString("success").equalsIgnoreCase("1")) {
                                ...
                                JSONArray data = response.optJSONArray("block_list");
                                ...
                                mutelistAdapter = new BlocklistAdapter(BlockedList.this, myFriendsLists);
                                block_list.setAdapter(mutelistAdapter);
...
//                viewHolder.designation = (TextView) convertView.findViewById(R.id.designation);
            ...
            viewHolder.unmutee.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (NetworkDetector.isNetworkStatusAvialable(BlockedList.this))
                    {
                        new android.support.v7.app.AlertDialog.Builder(BlockedList.this)
                                .setIcon(android.R.drawable.ic_dialog_alert)
                                .setTitle(R.string.app_name)
                                .setMessage("Are you sure want to UnBlock "+ result.getName().toUpperCase()+"?")
                    ...
                    {
                        Toast.makeText(BlockedList.this, "Please check your internet connection", Toast.LENGTH_SHORT).show();
                    }
...
//            viewHolder.designation.setText(result.getDesignation());
            ...
            /////picasso
            Picasso.with(BlockedList.this).load(result.getProfile_image())
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(BlockedList.this,OtherUserProfileActivity.class);
